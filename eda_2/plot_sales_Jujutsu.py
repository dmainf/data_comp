...
# グラフ関数
def plot_sum_by_book(df, output_dir='figure', store_id=None, book_name_filter='呪術廻戦'):
    import matplotlib.pyplot as plt
    import pandas as pd
    import numpy as np
    from pathlib import Path
    ...
    save_path = output_dir / f"Jujutsu_sales_store_{store_id}.png"
...
if __name__ == '__main__':
    ...
    print(f"\n{'='*60}")
    print("Starting parallel processing for '呪術廻戦'...")
    print('='*60)
    ...
    print(f"\n{'='*60}")
    print("All stores processed successfully for '呪術廻戦'!")
    print('='*60)
